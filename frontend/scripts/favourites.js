...
const PRESEEDED_TOOLS = [
  ...
  { id: 'compress', label: 'Compress PDF', desc: 'Reduce file size without quality loss', color: '#A855F7', bg: 'rgba(168,85,247,0.15)', tag: 'Tool', bottomHTML: '<div class="fmt-tag fmt-tag--tool">Tool</div>', iconHTML: '<svg width="26" height="26" viewBox="0 0 16 16" fill="none"><rect x="2" y="2" width="12" height="12" rx="1.5" stroke="currentColor" stroke-width="1.3"/><path d="M5 8h6M8 5v6" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><path d="M5 5l1.5 1.5M11 5l-1.5 1.5M5 11l1.5-1.5M11 11l-1.5-1.5" stroke="currentColor" stroke-width="1.1" stroke-linecap="round"/></svg>' },
